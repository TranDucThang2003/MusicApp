...
class SearchScreenState extends State<SearchScreen>{
  ...
  Widget build(BuildContext context) {
    ...
    List<Song> filterSong (){
      if(queryString.isEmpty) return audioController.songs;
      return audioController.songs.where((song){
        return song.songArtist.toLowerCase().contains(queryString.toLowerCase()) ||
    ...
    return Column(
        ...
        height: 50,
        child: TextField(
        decoration: InputDecoration(hintText: ("Tên bài hát, tên nghệ sĩ "),
          ...
          child: Row(
            ...
            children: [
              ...
              TextButton(onPressed: (){
                widget.switchPage(1);
              }, child: Text("view all",style: TextStyle(color: Colors.grey , fontSize: 10),))
            ],
          ),
        ),
        SizedBox(height: 10,),
              ...
              itemBuilder: (context, index) {
                ...
                return GestureDetector(
                  ...
                  child: SongItem(
                    ...
                    onClickFavorite: () => songController.handleFavoriteSong(filteredSongs[index]),
                  ),
                );
              },
            ),
